...
import io.blabla.sam.config.audit.AuditEventConverter;
import io.blabla.sam.domain.PersistentAuditEvent;
...
import static io.blabla.sam.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
